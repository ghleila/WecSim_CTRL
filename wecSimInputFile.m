...
simu.simMechanicsFile = 'Modif_pto_RM3_copy2.slx';      % Specify Simulink Model File
simu.mode = 'normal';                   % Specify Simulation Mode ('normal','accelerator','rapid-accelerator')
simu.explorer='off';                     % Turn SimMechanics Explorer (on/off)
simu.startTime = 0;                     % Simulation Start Time [s]
simu.rampTime = 100;                   	% Wave Ramp Time [s]
simu.endTime=100000;                       % Simulation End Time [s]
...
waves.T =8;                            % Wave Period [s]
 waves.spectrumType = 'JS';             %%% PM or JS or BS
...
pto(1).k = K2;                                   % PTO Stiffness [N/m]
pto(1).c = B2;                             % PTO Damping [N/(m/s)]
