...
%Tstep = 0.01;     %s      %step size for the simulation
 ...
 Ts =8;                 %s         %Significant period of the Wave
...
%% irregular waves - with Pierson-Moskowitz spectrum 
 ...
 B2Matrix=[0, 2e04, 3e04, 4e04, 5e04, 6e04, 7e04, 8e04, 9e04, 9.5e04];
 K2Matrix=[0, 1*9e04, 2*9e04, 3*9e04, 4*9e04, 5*9e04, 6*9e04, 7*9e04, 8*9e04, 9*9e04, 80e04];
...
etaTs=0.1;
 ...
 FeWithTime = [t(1/etaTs:end) Fe(1/etaTs:end)];
...
%  All_Params(:,6)=All_params3(:,6)/1e05;% Fe_Mag smalization :D
 ...
 %%%All_Params_round(:,1:4)=(All_Params_rounded(:,1:4));  %% no rounding for frequency
