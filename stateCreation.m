...
for i=1:size(Fe_F,2)
    ...
    for j=1:size(Fe_M,2)
        ...
        for k=1:size(B2Matrix,2)
            
            for l=1:size(K2Matrix,2)
                
                state_space(count,1)=Fe_F(1,i);
                
                state_space(count,2)=Fe_M(1,j);
                
                state_space(count,3)=B2Matrix(1,k);
                
                state_space(count,4)=K2Matrix(1,l);
 ...
 save('state_creation','state_space')
