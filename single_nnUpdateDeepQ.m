...
for episode=1:size(ini_epis_state_idx,2)
    ...
    %init_st=ini_epis_state_idx(1,episode);   %% initial state
    %init_st=1210;
...
%         end
        ...
        [All_params3,next_state_idx, PptoAvg]=SIMULATOR2(FeWithTime,A1,B1,K1,B2,K2,tsim,StepT_SIM);  ...
            % initiaL STATE
