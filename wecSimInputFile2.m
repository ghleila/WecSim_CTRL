...
simu.simMechanicsFile = 'RM3_ConstantKB.slx';      % Specify Simulink Model File
...
waves.H = Height;                          % Wave Height [m]
waves.T = Ts;                            % Wave Period [s]
...
%  pto(1).k = 1e6;                                   % PTO Stiffness [N/m]
%   pto(1).c = 1e6;                             % PTO Damping [N/(m/s)]
