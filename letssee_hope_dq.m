...
% initial network
prob=1;  %%%% probability of staying in the same sea state
...
%         end
    ...
    eta= eta';
        ...
        [All_params3,next_state_idx, PptoAvg]=SIMULATOR(FeWithTime,A1,B1,K1,B2,K2,tsim,StepT_SIM,state_idx,prob, init_st);  ...
            % initiaL STATE
