...
%                         Vel_Params(i,2),Pos_Params(i,2),Fe_Params(i,3), Fr_Params(i,3),Vel_Params(i,3),Pos_Params(i,3) B2_prime K2_prime PptoAvg(inter_count,1) ];
function [PptoAvg]=TstSimulatorF(FeWithTime,A1,B1,K1,B2,K2,tsim_ove,StepT_SIM,state_idx)
% loading state space
%load('states_spaceP','states_spaceP')

    
%states_space1=states_spaceP([6*9+1:9*7],:);
%states_space=states_spaceP([1:9 5*9+1:9*6 15*9+1:9*16],:);

% states_space(1,:)=states_space1(6,:);
% states_space(6,:)=states_space1(1,:);
% 
% states_space(2,:)=states_space1(9,:);
% states_space(9,:)=states_space1(2,:);
% 
% states_space(4,:)=states_space1(8,:);
% states_space(8,:)=states_space1(4,:);
% 
% states_space(3,:)=states_space1(7,:);
% states_space(7,:)=states_space1(3,:);
...
% % % 
% % % elementVel=logsout{4};
% % % Vel=elementVel.Values.Data;
% % % 
% % % elementPos=logsout{5};
...
% % % % 
% % % % %% Fr parameters
% % % % Fr=Fr(15/StepT_SIM:end-5/StepT_SIM);  %%% moise extraction
% % % % Fr = Fr - mean(Fr);
% % % % %%% amplitude and phase
...
% % % % 
% % % % %% position parameters
% % % % Pos=Pos(15/StepT_SIM:end-5/StepT_SIM);  %%% moise extraction
% % % % Pos = Pos - mean(Pos);
% % % % %%% amplitude and phase
...
% % % % 
% % % % %% Velocity parameters
% % % % Vel= Vel(15/StepT_SIM:end-5/StepT_SIM);  %%% moise extraction
% % % % Vel = Vel - mean(Vel);
% % % % 
% % % % %%% amplitude and phase
% % % % 
